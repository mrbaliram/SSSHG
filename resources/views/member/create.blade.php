                    ...
                    <form action="{{ route('member.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <select id="user_id" name="user_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    ...
                                    @foreach($userResults as $userData)
                                        <option value="{{ $userData->id }}"> {{ $userData->name }} [{{ $userData->email }}]</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input  type="text" name="guardian" id="guardian" value="{{old('guardian')}}" class="border rounded-md w-full py-2 px-3 text-gray-700" required>
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="email" name="email" id="email" value="{{old('email')}}" class="border rounded-md w-full py-2 px-3 text-gray-700" >
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="text" name="phone" id="phone" value="{{old('phone')}}" class="border rounded-md w-full py-2 px-3 text-gray-700">
                            </div>                            
                            <div class="relative z-0 w-full mb-6 group">
                        ...
                        <div class="flex justify mb-6">
                            ...
                            <div class="flex items-center mr-4">
                                <input type="radio" name="gender" id="active" value="M" checked>
                                <label for="active" class="text-gray-700">Male</label>
                            </div>
                            <div class="flex items-center mr-4">
                                <input type="radio" name="gender" id="inactive" value="F" }} class="mr-2">
