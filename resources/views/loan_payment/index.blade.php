                                ...
                                @foreach($results as $data)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <a title="Show the details" target="_blank" class="inline-flex items-center text-blue-600 hover:underline" href="{{ route('society_member.show', $data->societyMemberId) }}">{{ $data->memberName }} [{{ $data->societyName }}]</a>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 flex">
                                            ...
                                            @endif
                                             <!-- Show details button  -->
                                            <a title="show details" href="{{ route('loan_account.show', $data->loan_account_id) }}" class="text-blue-600 hover:underline">
